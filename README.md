...
- **Generalist Software Engineer** with a strong focus on fullstack development and system architecture.
- **Problem Solver:** Deep-rooted foundation in Data Structures and Algorithms (DSA).
- **Researcher:** Previously published research on neural networks aimed at assisting individuals with hearing and speech impairments.
...
| :--- | :--- |
| **Languages** | Java, Python, JavaScript (ES6+), C++, C |
| **Backend** | Spring Boot, Node.js, Express.js, Spring Data JPA, Flask |
| **Frontend** | React.js, Tailwind CSS, SCSS, Material UI, HTML5/CSS3 |
...
#### 🏗️ [Design Pattern Hub](https://design-hub-frontend-theta.vercel.app/)
*An interactive platform to master all 23 GoF design patterns with real-world applications.*
- **Key Features:** Interactive class diagrams, progress tracking, and quiz modules.
- **Use Cases:** Modeled systems like Amazon Locker and Library Management.
- **Tech:** React, Node.js, MongoDB.

#### 💬 [Chit-Chat App](https://github.com/shalini47ch/chit-chat-frontend)
*A real-time communication suite focused on low-latency messaging.*
...
| :--- | :--- |
| [Unveiling the Power Of Promises](https://medium.com/@shalini47choudhary/unveiling-the-power-of-promises-in-javascript-739c6a243464) | JavaScript Asynchrony |
| [Adapter Design Pattern](https://medium.com/@shalini47choudhary/adapter-design-pattern-your-key-to-compatibility-in-coding-1d448014db2f) | Structural Design |
...
- **Visitor Count:** ![Visitor Badge](https://visitor-badge.laobi.icu/badge?page_id=shalini47ch.shalini47ch)
